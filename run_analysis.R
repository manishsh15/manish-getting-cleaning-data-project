### getting and cleaning data project by Manish Sharma
...
## 5. Data step in set 4 creates a second, independent tidy data set with the average of each variable for each activity and each subject.
###########
##  workspace cleaning
> rm(list=ls())
##1. Merges the training and the test sets to create one data set.
## set working directory
setwd('/Users/manish/Documents/UCI HAR Dataset/');
...
## Assigned column names to the test data 
